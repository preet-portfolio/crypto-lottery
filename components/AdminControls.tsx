...
import {
    useContract,useContractCall, useContractData,
...
function AdminControls() {
    ...
    const { mutateAsync: restrartDraw } = useContractCall(
        contract,
        "restrartDraw"
    );
    ...
    const drawWinner = async () => {
        const notification = toast.loading("Picking a Lucky Number...")
        try {
  ...
  return (
    ...
    {totalCommission &&
    ethers.utils.formatEther(totalCommission?.toString())}{"0.013"}{""}{currency}
