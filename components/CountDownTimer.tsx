...
const renderer = ({hours, minutes, seconds, completed }: Props) => {
    if (completed) {
        return(
        <div>
            <h2 className='text-white text-xl text-center animate-bounce'>Ticket sales have now CLOSED for this draw. but You can still BUY it </h2>
            <div>
        ...
        return(
<div>
            <h3 className='text-white text-sm mb-2 italic'>Tinme Remaining</h3>
            <div className='flex space-x-6'>
                <div className='flex-1'>
